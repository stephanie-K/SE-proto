...
<html lang="{{ htmlLang | default('en') }}" class="govuk-template {{ htmlClasses }}">
  <head>
    <meta charset="utf-8" />
    <title>{% block pageTitle %}This is a prototype for Scottish Enterprise{% endblock %}</title>
  ...
  <body class="govuk-template__body {{ bodyClasses }}">
    ...
    {# added by Stephanie to try to add breadcrumbs area and hero full width just after header #}
    {% block postHeader %}
    {% endblock %}
